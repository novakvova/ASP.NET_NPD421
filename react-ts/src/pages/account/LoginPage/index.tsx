...
const LoginPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try
        {
            ...
            const result = await loginRequest(form).unwrap(); // з unwrap() поміг chatgpt. По простому він просто розкриває Promise який генерує QueryRTK
        ...
        <>
            ...
            <form className="max-w-md mx-auto" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a href="http://localhost:5267/api/Account/GoogleLogin">
                        <button type="button"
